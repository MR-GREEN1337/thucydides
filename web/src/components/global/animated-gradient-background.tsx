...
interface AnimatedGradientBackgroundProps {
   ...
   /**
    * Vertical position of the radial gradient's center.
    * @default 20
    */
   gradientYPosition?: number;
}
...
const AnimatedGradientBackground: React.FC<AnimatedGradientBackgroundProps> = ({
   ...
   useEffect(() => {
      ...
      const animateGradient = () => {
         ...
         const gradient = `radial-gradient(${width}% ${width+topOffset}% at 50% ${gradientYPosition}%, ${gradientStopsString})`;
   ...
   }, [startingGap, Breathing, gradientColors, gradientStops, animationSpeed, breathingRange, topOffset, gradientYPosition]);
